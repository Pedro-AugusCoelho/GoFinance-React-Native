...
export const DirectionButton = styled.TouchableOpacity<{ active: boolean }>`
    flex: 1;
    height: ${RFValue(44)}px;
    background-color: ${({ active, theme }) => active ? theme.colors.primary : theme.base.shape_secondary};
    border: 1px solid ${({ active, theme }) => active ? theme.colors.primary : theme.base.shape_third};
    border-radius: 8px;
    flex-direction: row;
    align-items: center;
    justify-content: center;
...
export const DirectionButtonIcon = styled(Feather)<{ active: boolean }>`
    font-size: ${RFValue(16)}px;
    color: ${({ active, theme }) => active ? theme.base.white : theme.colors.text};
    margin-right: ${RFValue(6)}px;
`;

export const DirectionButtonText = styled.Text<{ active: boolean }>`
    font-family: ${({ theme }) => theme.fonts.medium};
