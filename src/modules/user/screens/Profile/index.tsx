...
export function Profile() {
    ...
    async function handlePickImage () {
        try {
            ...
            Alert.alert('Erro', getErrorMessage(error, 'Não foi possível selecionar a foto.'))
        }
    }
    ...
    async function handleEditProfile(form: FormData) {
        ...
        try {
            ...
            Alert.alert('Erro', getErrorMessage(error, 'Não foi possível atualizar o nome.'))
        }
    }
    ...
    async function handleCreateBackup () {
        ...
        try {
            ...
            Alert.alert('Erro', getErrorMessage(error, 'Não foi possível criar o backup.'))
        } finally {
                ...
                },
                {
                    ...
                    onPress: async () => {
                        ...
                        try {
                            ...
                            Alert.alert('Erro', getErrorMessage(error, 'Não foi possível restaurar o backup.'))
                        } finally {
